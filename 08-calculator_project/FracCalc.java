...
public class Main{
  ...
  // Return: return the numerator, denominator, and whole as checkpoint2(results)
    public static String produceAnswer(String input){
      ...
      if(operator.contains("*")){
        System.out.println("The results is: " + multiply(numerator1, numerator2,  Whole1,  Whole2,  denominator1, denominator2));
  ...
  // Input:
  // Return
    public static String multiply(int numerator1, int numerator2, int Whole1, int Whole2, int denominator1, int denominator2){
     if(Whole1 == 0 || Whole2 == 0){
      ...
      if(Whole1 != 0 || Whole2 != 0){
        ...
        int removeWhole2 = (denominator2 * Whole2) + numerator2;
